...
func TestDefine(t *testing.T) {
	...
	c, err := firstLocal.Define("c", false)
	if err != nil {
		t.Errorf("unexpected error: %s", err)
	}
	if c != expected["c"] {
	...
	d, err := firstLocal.Define("d", false)
	if err != nil {
		t.Errorf("unexpected error: %s", err)
	}
	if d != expected["d"] {
	...
	e, err := secondLocal.Define("e", false)
	if err != nil {
		t.Errorf("unexpected error: %s", err)
	}
	if e != expected["e"] {
	...
	f, err := secondLocal.Define("f", false)
	if err != nil {
		t.Errorf("unexpected error: %s", err)
	}
	if f != expected["f"] {
